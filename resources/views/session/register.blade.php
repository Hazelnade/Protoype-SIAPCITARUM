      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Formulir luar biasa ini untuk masuk atau membuat akun baru.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  @error('agreement')
                    <p class="text-danger text-xs mt-2">Setujui dulu Syarat dan Ketentuannya, lalu coba daftar lagi.
                    </p>
                  @enderror
                </div>
